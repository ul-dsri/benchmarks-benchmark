...
\textbf{Disclaimers}
\begin{itemize}
\item $B_2$ is being actively developed and updated through time.
...
\section{\texorpdfstring{$B_2$}{B2} Design, Interpretation, and Reliability}
